...
// Assuming you have the necessary imports and dependencies set up
...
// Controller to get product quantity by ID
export const getProductQuantityById = async (req, res) => {
  try {
